...
#lr=0.002
p3.main("Yoshi", "Q", lr=0.002, dr=0.95, er=1.0, ed=200000, emin=0.02, model="e5-extendedTest2-recovery", learn=learn, selfSelect=True, level=9, default=default, headless=headless)
