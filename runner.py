...
p3.main("Yoshi", "Q", lr=0.1, dr=0.95, er=1.0, ed=200000, emin=0.01, model="3-23-2020-NormInputManualRecovery", learn=learn, selfSelect=True, level=9, default=default, headless=headless)
