...
p3.main("Yoshi", "Q", lr=0.1, dr=0.95, er=1.0, ed=20000, emin=0.01, model="3-18-2020-120Prediction", learn=learn, selfSelect=True, level=9, default=default, headless=headless)
